...
app = typer.Typer(
    name="pyln",
    help="3D line art engine (based on ln)",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(f"[yellow]pyln[/] version: [bold blue]{__version__}[/]")
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the pyln package.",
    ),
):
